...
import type { Blog, DocumentTypes, Snippets } from 'contentlayer/generated'
...
export function sortedSnippets(allSnippets: Snippets[]) {
  return allSnippets.sort((a, b) => dateSortDesc(a.date, b.date))
}
