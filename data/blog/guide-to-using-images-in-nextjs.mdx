...
function Home() {
  return (
    <>
      <h1>My Homepage</h1>
      <Image src={`${process.env.PUBLIC_IMG}me.png`} alt="Picture of the author" width={500} height={500} />
...
```js
<Image alt="ocean" src={`${process.env.PUBLIC_IMG}ocean.jpg`} width={256} height={128} />
```
